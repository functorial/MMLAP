...
namespace MMLAP
{
    public static class Addresses
    {
        ...
        public static readonly AddressData OutOfTitleLoading                              = new(0x981AF, 0, null);
        ...
        public static readonly AddressData HasActivatedEmergencySystem                    = new(0xBE37C, 6, null); // This bit is checked for starting Gesellschaft fight
