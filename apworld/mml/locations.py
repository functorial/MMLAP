...
locationDataDict = {
    ...
    "Underground ruins, Horokko ledge chest"                        : LocationData(46,  LocationCategory.CONTAINER, False),
    "Underground ruins, Clozer exit chest"                          : LocationData(47,  LocationCategory.CONTAINER, False),
